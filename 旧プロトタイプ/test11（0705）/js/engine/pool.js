...
const PANEL_POOL=[
  ...
  {id:'panel_mata',no:'002',name:'マータ',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',subCategory:'特殊',color:'赤',cost:1,slot:1,power:0,life:7,manaOnInjury:'red',desc:'負傷：赤マナを得る。'},
  ...
  {id:'panel_elf',no:'008',name:'エルフ',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',subCategory:'特殊',color:'黄',manaCost:2,manaColor:'yellow',cost:1,slot:1,power:5,life:3,keywords:['先制','シールド'],desc:'先制　シールド'},
  ...
  {id:'panel_archdemon',no:'010',name:'アークデーモン',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',subCategory:'特殊',color:'赤',manaCost:3,manaColor:'red',cost:1,slot:1,power:25,life:20,desc:'召喚：ランダムな前衛の敵1体を破壊する。'},
  {id:'panel_arassas',no:'011',name:'アラッサス',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',subCategory:'特殊',color:'青',manaCost:4,manaColor:'blue',cost:1,slot:1,power:15,life:15,desc:'召喚：全ての敵に3ダメージを与える。'},
  {id:'panel_slin',no:'012',name:'スリン',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',subCategory:'特殊',color:'緑',manaCost:3,manaColor:'green',cost:1,slot:1,power:10,life:20,keywords:['毒牙3'],desc:'毒牙3'},
  ...
  {id:'panel_imp',no:'025',name:'インプ',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'赤',cost:1,slot:1,power:2,life:1,keywords:['根性'],desc:'根性'},
  {id:'panel_madness',no:'026',name:'狂気',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'エンチャント',cost:1,slot:1,adjacentKeywords:['狂気'],desc:'死亡：青マナを得る。'},
  {id:'panel_wild_power',no:'027',name:'野生の力',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'エンチャント',cost:1,slot:1,adjacentKeywords:['野生の力'],desc:'召喚：緑マナを得る。'},
