...
const PANEL_POOL=[
  {id:'panel_atk_1',name:'攻撃力強化　Lv.1',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:1,atkBonus:2,desc:'常時：ATK+2'},
  {id:'panel_atk_2',name:'攻撃力強化　Lv.2',rarity:1,grade:2,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:2,atkBonus:5,desc:'常時：ATK+5'},
  {id:'panel_atk_3',name:'攻撃力強化　Lv.3',rarity:1,grade:3,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:3,atkBonus:10,desc:'常時：ATK+10'},
  {id:'panel_atk_4',name:'攻撃力強化　Lv.4',rarity:1,grade:4,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:4,atkBonus:18,desc:'常時：ATK+18'},
  {id:'panel_atk_5',name:'攻撃力強化　Lv.5',rarity:1,grade:5,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:5,atkBonus:30,desc:'常時：ATK+30'},
  {id:'panel_hp_1',name:'生命力強化　Lv.1',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:1,hpBonus:4,desc:'常時：HP+4'},
  {id:'panel_hp_2',name:'生命力強化　Lv.2',rarity:1,grade:2,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:2,hpBonus:8,desc:'常時：HP+8'},
  {id:'panel_hp_3',name:'生命力強化　Lv.3',rarity:1,grade:3,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:3,hpBonus:15,desc:'常時：HP+15'},
  {id:'panel_hp_4',name:'生命力強化　Lv.4',rarity:1,grade:4,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:4,hpBonus:25,desc:'常時：HP+25'},
  {id:'panel_hp_5',name:'生命力強化　Lv.5',rarity:1,grade:5,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:5,hpBonus:40,desc:'常時：HP+40'},
  {id:'panel_power_1',name:'戦闘力強化　Lv.1',rarity:2,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:2,atkBonus:3,hpBonus:6,mergeFrom:['攻撃力強化　Lv.1','生命力強化　Lv.1'],desc:'常時：+3/+6'},
  {id:'panel_power_2',name:'戦闘力強化　Lv.2',rarity:2,grade:2,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:4,atkBonus:6,hpBonus:10,mergeFrom:['攻撃力強化　Lv.2','生命力強化　Lv.2'],desc:'常時：+6/+10'},
  {id:'panel_power_3',name:'戦闘力強化　Lv.3',rarity:2,grade:3,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:6,atkBonus:12,hpBonus:18,mergeFrom:['攻撃力強化　Lv.3','生命力強化　Lv.3'],desc:'常時：+12/+18'},
  {id:'panel_power_4',name:'戦闘力強化　Lv.4',rarity:2,grade:4,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:8,atkBonus:20,hpBonus:28,mergeFrom:['攻撃力強化　Lv.4','生命力強化　Lv.4'],desc:'常時：+20/+28'},
  {id:'panel_power_5',name:'戦闘力強化　Lv.5',rarity:2,grade:5,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:10,atkBonus:35,hpBonus:45,mergeFrom:['攻撃力強化　Lv.5','生命力強化　Lv.5'],desc:'常時：+35/+45'},
  {id:'panel_battle_master',name:'バトルマスター',rarity:-1,grade:6,type:'panel',kind:'panel',panelScope:'unit',category:'戦闘力',cost:0,atkBonus:80,hpBonus:100,mergeFrom:['戦闘力強化　Lv.5','戦闘力強化　Lv.5'],desc:'常時：+80/+100'},
  ...
  {id:'panel_great_growth',name:'大いなる成長',rarity:2,grade:4,type:'panel',kind:'panel',panelScope:'unit',category:'パッシブ',cost:5,slot:2,desc:'常時：味方の成長効果は1回追加で発動する。'},
  {id:'panel_training_1',name:'修練　Lv.1',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'成長',cost:2,slot:1,desc:'成長：+1/+1を得る。'},
  {id:'panel_training_2',name:'修練　Lv.2',rarity:1,grade:2,type:'panel',kind:'panel',panelScope:'unit',category:'成長',cost:4,slot:1,desc:'成長：+2/+2を得る。'},
  {id:'panel_training_3',name:'修練　Lv.3',rarity:2,grade:3,type:'panel',kind:'panel',panelScope:'unit',category:'成長',cost:6,slot:1,desc:'成長：+4/+4を得る。'},
  {id:'panel_training_4',name:'修練　Lv.4',rarity:2,grade:4,type:'panel',kind:'panel',panelScope:'unit',category:'成長',cost:8,slot:1,desc:'成長：+8/+8を得る。'},
  {id:'panel_training_5',name:'修練　Lv.5',rarity:3,grade:5,type:'panel',kind:'panel',panelScope:'unit',category:'成長',cost:10,slot:1,desc:'成長：+12/+12を得る。'},
  {id:'panel_magic_basic',name:'魔術の基礎',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'成長',cost:1,slot:1,desc:'成長：魔術レベルが3以下の場合、魔術レベルが+1される。'},
  {id:'panel_magic_apply',name:'魔術の応用',rarity:1,grade:3,type:'panel',kind:'panel',panelScope:'unit',category:'成長',cost:2,slot:1,desc:'成長：魔術レベルが+1される。'},
  {id:'panel_small_coin',name:'小銭回収',rarity:1,grade:2,type:'panel',kind:'panel',panelScope:'unit',category:'成長',cost:3,slot:2,desc:'成長：1金を得る。'},
  {id:'panel_stash',name:'へそくり',rarity:1,grade:3,type:'panel',kind:'panel',panelScope:'unit',category:'成長',cost:5,slot:2,desc:'成長：2金を得る。'},
  {id:'panel_repair_plan',name:'改修計画',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'成長',cost:3,slot:1,desc:'成長：ランダムな設備のアップグレードコストが1下がる。'},
  {id:'panel_dragon_body',name:'竜体化',rarity:3,grade:4,type:'panel',kind:'panel',panelScope:'unit',category:'成長',cost:2,slot:2,desc:'成長：3回目の戦闘終了時、ランダムな竜に変身し、これを破壊する。'},
  {id:'panel_transform',name:'変身',rarity:2,grade:3,type:'panel',kind:'panel',panelScope:'unit',category:'成長',cost:1,slot:2,desc:'成長：ランダムなキャラクターに変身する。'},
  {id:'panel_spread',name:'流布',rarity:1,grade:3,type:'panel',kind:'panel',panelScope:'unit',category:'成長',cost:1,slot:1,desc:'成長：右隣のパネルを販売プールに追加する。'},
  {id:'panel_gluttony',name:'暴食',rarity:1,grade:4,type:'panel',kind:'panel',panelScope:'unit',category:'成長',cost:1,slot:1,desc:'成長：右隣のパネルを破壊し、+X/+Xを得る。Xは破壊したパネルのグレードの3倍に等しい。右隣にパネルがない場合はこれを破壊する。'},
];
...
function drawPanel(n=1, maxGrade){
  ...
  const pool=PANEL_POOL.filter(p=>p&&p.id&&p.rarity!==-1&&(p.grade||1)<=targetGrade&&panelSaleStockCount(p)>0);
  const res=[];
  let t=0;
...
function drawRewards(n){
  ...
  const res=drawPanel(4, appraiser?boostGrade:undefined);
