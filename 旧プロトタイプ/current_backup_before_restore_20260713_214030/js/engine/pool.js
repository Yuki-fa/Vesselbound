...
const PANEL_POOL=[
  ...
  {id:'panel_mata',no:'002',name:'マータ',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'赤',cost:1,slot:1,race:'亜人',power:0,life:7,manaOnInjury:1,desc:'負傷：1マナを得る。'},
  ...
  {id:'panel_dwarf',no:'005',name:'ドワーフ',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'赤',cost:1,slot:1,race:'亜人',power:3,life:5,desc:'常時：このキャラクターは+X/+Xを得る。Xはマナの数に等しい。'},
  ...
  {id:'panel_minotaur',no:'009',name:'ミノタウロス',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'赤',cost:1,slot:1,race:'亜人',power:4,life:5,desc:'常時：このキャラクターの攻撃効果は1回追加で発動する。'},
  {id:'panel_harpy',no:'010',name:'ハーピー',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'赤',cost:1,slot:1,race:'亜人',power:5,life:3,desc:'負傷：直ちにランダムな敵に攻撃する。'},
  ...
  {id:'panel_formorian',no:'013',name:'フォルモール',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'赤',cost:1,slot:1,race:'亜人',power:4,life:4,desc:'常時：右隣のキャラクターの負傷効果は1回追加で発動する。'},
  {id:'panel_titan',no:'014',name:'タイタン',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'赤',cost:1,slot:1,race:'亜人',power:6,life:4,desc:'開戦：全ての敵に弱体3を与える。'},
  ...
  {id:'panel_sentinel',no:'016',name:'センチネル',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'赤',cost:1,slot:1,race:'アーティファクト',power:5,life:5,manaCost:3,desc:'3マナ：「赤ゴーレム」（3/3）を召喚する。'},
  ...
  {id:'panel_cyclops',no:'018',name:'サイクロプス',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'赤',cost:1,slot:1,race:'亜人',power:4,life:6,desc:'負傷：リーダーは+1/+1を得る。'},
  ...
  {id:'panel_hecatoncheir',no:'020',name:'ヘカトンケイル',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'赤',cost:1,slot:1,race:'亜人',power:0,life:1,desc:'常時：XはリーダーのATK、HPの2倍に等しい。'},
  ...
  {id:'panel_skeleton',no:'022',name:'スケルトン',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'青',cost:1,slot:1,race:'不死',power:4,life:2,desc:''},
  ...
  {id:'panel_wraith',no:'025',name:'レイス',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'青',cost:1,slot:1,race:'不死',power:6,life:1,desc:'死亡：「レイス」以外のランダムな味方に復活を付与する。'},
  {id:'panel_skeleton_king',no:'026',name:'スケルトンキング',rarity:3,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'青',cost:1,slot:1,race:'不死',power:4,life:4,desc:'開戦：全ての味方は「死亡：「青スケルトン」（3/1）を召喚する。」を得る。'},
  ...
  {id:'panel_lemures',no:'031',name:'レムレース',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'青',cost:1,slot:1,race:'不死',power:4,life:3,desc:'死亡：このキャラクターを死亡させたキャラクターに変身する。'},
  ...
  {id:'panel_lich',no:'039',name:'リッチ',rarity:1,grade:1,type:'panel',kind:'panel',panelScope:'unit',category:'キャラクター',color:'青',cost:1,slot:1,race:'不死',power:7,life:3,desc:'常時：味方が死亡するたび、ランダムな敵に4ダメージを与える。'},
