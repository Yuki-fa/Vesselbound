...
const UNIT_POOL = [
  ...
  {id:'c_centaur',    name:'ケンタウロス',     race:'亜人', grade:2, atk:9,  hp:24, cost:5,  unique:false, icon:'🏇', desc:'開戦：魔術レベルが+1される。', effect:'centaur_start'},
  ...
  {id:'c_siren',      name:'サイレン',         race:'亜人', grade:3, atk:12, hp:42, cost:7,  unique:false, icon:'🎶', desc:'攻撃：オーナーの魔術レベルが+1される。', effect:'siren_attack'},
  ...
  {id:'c_elvenmage',  name:'エルヴンメイジ',   race:'精霊', grade:4, atk:18, hp:75,  cost:10, unique:false, icon:'🧙', desc:'誘発：オーナーが使用した杖の効果は2回発動する。', effect:'elvenmage_wand_double'},
