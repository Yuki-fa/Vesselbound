...
const UNIT_POOL = [
  ...
  {id:'c_centaur',    name:'ケンタウロス',     race:'亜人', grade:2, atk:9,  hp:24, cost:5,  unique:false, icon:'🏇', desc:'二段攻撃　攻撃：最もライフが低い敵に「炎の杖」を使用する。',        effect:'centaur_attack', keywords:['二段攻撃']},
  ...
  {id:'c_sea_serpent',name:'シーサーペント',   race:'獣',   grade:2, atk:10, hp:20, cost:5,  unique:false, icon:'🐍', desc:'毒牙　開戦：全ての敵に3ダメージを与える。', effect:'sea_serpent_start', keywords:['毒牙']},
  // キーワードのみG2
