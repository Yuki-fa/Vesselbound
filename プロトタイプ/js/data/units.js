...
const UNIT_POOL = [
  ...
  {id:'c_gremlin',    name:'グレムリン',       race:'悪魔', grade:1, atk:4,  hp:8,  cost:4,  unique:false, icon:'👺', desc:'開戦：相手オーナーのインベントリのカードを破壊し、1ソウルを得る。', effect:'gremlin_start'},
  ...
  {id:'c_slin',       name:'スリン',           race:'亜人', grade:1, atk:2,  hp:10, cost:4,  unique:false, icon:'🌿', desc:'誘発：負傷効果が発動するたび、全ての「竜」のライフが+1される。', effect:'slin_injury_aura'},
  ...
  // ─── G2 通常 ───
  {id:'c_worm',       name:'ワーム',           race:'竜',   grade:2, atk:9,  hp:22, cost:7,  unique:false, icon:'🪱', desc:'反撃　負傷：全ての仲間が+3/+2を得る。', counter:true, injury:'worm', keywords:['反撃']},
  {id:'c_darkone',    name:'ダークワン',       race:'悪魔', grade:2, atk:6,  hp:12, cost:5,  unique:false, icon:'😈', desc:'誘発：アイテムを使用するたび、全ての「悪魔」が+1/+1を得る。', effect:'darkone_spell'},
  {id:'c_drake',      name:'ドレイク',         race:'竜',   grade:2, atk:5,  hp:8,  cost:3,  unique:false, icon:'🐲', desc:'常時：仲間がダメージを受ける時、その仲間のライフが+3される。', effect:'drake_mitigate'},
  {id:'c_lindworm',   name:'リンドヴルム',     race:'竜',   grade:2, atk:9,  hp:6,  cost:5,  unique:false, icon:'🐍', desc:'誘発：負傷効果が発動するたび、全ての「竜」のパワーが+2される。', effect:'lindworm_injury'},
  ...
  {id:'c_gargoyle',   name:'ガーゴイル',       race:'悪魔', grade:2, atk:7,  hp:25, cost:5,  unique:false, icon:'🗿', desc:'反撃　常時：全ての「悪魔」へのバフは+1される。', counter:true, effect:'gargoyle_bonus', keywords:['反撃']},
  ...
  {id:'c_harpy',      name:'ハーピー',         race:'亜人', grade:2, atk:3,  hp:21, cost:5,  unique:false, icon:'🦅', desc:'反撃　誘発：魔術レベルが上がるたび、全ての「亜人」が+1/+2を得る。', effect:'harpy_magiclevel', counter:true, keywords:['反撃']},
  ...
  {id:'c_specter',    name:'スペクター',       race:'不死', grade:2, atk:9,  hp:23, cost:5,  unique:false, icon:'👤', desc:'開戦：全ての敵に「死亡：隣接するキャラクターに3ダメージを与える。」を与える。', effect:'specter_start'},
  {id:'c_ghost',      name:'ゴースト',         race:'不死', grade:2, atk:7,  hp:20, cost:5,  unique:false, icon:'👻', desc:'誘発：他のキャラクターが死亡するたび、全ての「不死」のライフが+1される。', effect:'ghost_ondeath'},
  ...
  {id:'c_centaur',    name:'ケンタウロス',     race:'亜人', grade:2, atk:9,  hp:24, cost:5,  unique:false, icon:'🏇', desc:'二段攻撃　開戦：魔術レベルが+1される。',        effect:'centaur_start', keywords:['二段攻撃']},
  ...
  {id:'c_dryad',      name:'ドリアード',       race:'精霊', grade:2, atk:8,  hp:22, cost:5,  unique:false, icon:'🌿', desc:'攻撃：隣接するキャラクターの種族が+1/+1を得る。', effect:'dryad_attack'},
  {id:'c_warg',       name:'ウォーグ',         race:'獣',   grade:2, atk:9,  hp:22, cost:5,  unique:false, icon:'🐺', desc:'負傷：全ての「獣」が+1/+1を得る。', injury:'warg'},
  {id:'c_pegasus',    name:'ペガサス',         race:'獣',   grade:2, atk:10, hp:20, cost:5,  unique:false, icon:'🦄', desc:'攻撃：全ての前衛の味方のライフが+4される。', effect:'pegasus_attack'},
  ...
  {id:'c_kobold',     name:'コボルド',         race:'亜人', grade:2, atk:7,  hp:22, cost:5,  unique:false, icon:'🐊', desc:'誘発：杖を使うたび、全ての仲間が+1/+2を得る。', effect:'kobold_wand'},
  ...
  {id:'c_undine',     name:'ウンディーネ',     race:'精霊', grade:2, atk:8,  hp:22, cost:5,  unique:false, icon:'💧', desc:'常時：仲間の「精霊」が攻撃するたび、全ての「精霊」のライフが+1される。', effect:'undine_passive'},
  ...
  {id:'c_leprechaun', name:'レプラコーン',     race:'精霊', grade:2, atk:5,  hp:28, cost:5,  unique:false, icon:'🍀', desc:'誘発：ソウルを得るたび、全ての「精霊」のライフが+1される。', effect:'leprechaun_gold'},
  ...
  {id:'c_sea_serpent',name:'シーサーペント',   race:'獣',   grade:2, atk:10, hp:20, cost:5,  unique:false, icon:'🐍', desc:'毒牙　負傷：全ての相手キャラクターに4ダメージを与える。', injury:'sea_serpent', keywords:['毒牙']},
  // キーワードのみG2
  ...
  {id:'c_ogre',       name:'オーガ',           race:'亜人', grade:3, atk:14, hp:55, cost:7,  unique:false, icon:'👹', desc:'身代わり', effect:'bodyguard'},
  ...
  {id:'c_medusa',     name:'メデューサ',       race:'亜人', grade:3, atk:13, hp:50, cost:7,  unique:false, icon:'🐍', desc:'全てのキャラクターからライフを2奪う', effect:'medusa_drain'},
  {id:'c_wyvern',     name:'ワイバーン',       race:'竜',   grade:3, atk:17, hp:44, cost:7,  unique:false, icon:'🐲', desc:'攻撃：すべての味方が+3/+1を得る。'},
  {id:'c_scylla',     name:'スキュラ',         race:'獣',   grade:3, atk:15, hp:45, cost:7,  unique:false, icon:'🦑', desc:'開戦：このキャラクターと、ランダムな敵のライフを入れ替える。', effect:'scylla_start'},
