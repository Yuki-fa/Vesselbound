...
const SPELL_POOL=[
  ...
  {id:'w_hate',       name:'ヘイトの杖', type:'wand', cost:2,
   desc:'味方に使うと敵が優先的に狙う。敵に使うと味方が優先的に狙う。', effect:'hate', needsAny:true, baseUses:4},
  ...
  {id:'w_sacrifice',  name:'犠牲の杖',  type:'wand', cost:2,
   desc:'対象の仲間を破壊し、全ての敵にその仲間のATKに等しいダメージを与える。', effect:'sacrifice', needsAlly:true, baseUses:4},

  {id:'w_boost_atk',  name:'強化の杖',  type:'wand', cost:2,
   desc:'対象の仲間に+3/±0を与える。', effect:'boost_atk', needsAlly:true, baseUses:3},

  {id:'w_swap_pos',   name:'転移の杖',  type:'wand', cost:3,
   desc:'同じチームのキャラクター2体の位置を入れ替える。', effect:'swap_pos', baseUses:4},

  {id:'w_weaken',     name:'脱力の杖',  type:'wand', cost:2,
   desc:'対象のATKを0にする（1ターン）。', effect:'weaken', needsAny:true, baseUses:3},
  ...
  {id:'w_meteor',     name:'隕石の杖',  type:'wand', cost:3,
   desc:'ランダムなキャラクターに3ダメージを3回与える。', effect:'meteor_multi', baseUses:4},

  {id:'w_doom',       name:'破滅の杖',  type:'wand', cost:3,
   desc:'全ての敵に5ダメージを与える。', effect:'doom', baseUses:4},

  {id:'w_possess',    name:'憑依の杖',  type:'wand', cost:3,
   desc:'対象の仲間と、最もATKの低い敵の位置を入れ替える。', effect:'possess', needsAlly:true, baseUses:4},

  {id:'w_confusion',  name:'混乱の杖',  type:'wand', cost:2,
   desc:'対象のキャラクターのATKとHPを入れ替える。', effect:'swap_stats', needsAny:true, baseUses:4},
  ...
  {id:'c_regen',       name:'アンデッドの秘宝',type:'consumable', cost:2,
   desc:'対象の仲間に再生を与える。毎ターン開始時HP+3。', effect:'regen_grant', needsAlly:true},
