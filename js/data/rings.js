...
const RING_POOL=[
  ...
  {id:'r_bond',         name:'絆の指輪',       kind:'passive', grade:1,
  ...
  {id:'r_farsight',     name:'遠見の指輪',     kind:'passive', grade:1,
   desc:'祭壇、商店、宿屋の出現率が2倍になる。', unique:'farsight'},

  {id:'r_mana',         name:'魔導の指輪',     kind:'passive', grade:1,
  ...
  {id:'r_solitude',     name:'孤高の指輪',     kind:'passive', grade:1,
   desc:'盤面に味方が1体だけの時、その味方のATKとHPを2倍にする。', unique:'solitude'},

  {id:'r_greed',        name:'強欲の指輪',     kind:'passive', grade:1,
   desc:'宝箱の出現率が2倍になる。', unique:'greed'},

  {id:'r_mirror',       name:'鏡の指輪',       kind:'passive', grade:1,
   desc:'右隣の指輪と同じ効果を持つ。', unique:'mirror'},

  {id:'r_patience',     name:'我慢の指輪',     kind:'passive', grade:1,
