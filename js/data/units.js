...
const UNIT_POOL = [
  ...
  {id:'c_jackalope',  name:'ジャッカロープ',   race:'獣',   grade:1, atk:4,  hp:8,  cost:4,  unique:false, icon:'🐰', desc:'使役：オーナーは「治癒の薬」を2枚得る。', effect:'jackalope_summon'},
  {id:'c_pigmy',      name:'ピグミー',         race:'亜人', grade:1, atk:1,  hp:8,  cost:3,  unique:false, icon:'🏹', desc:'常時：このキャラクターの本来のパワーは魔術レベルに等しい。', effect:'pigmy_magic', counter:true},
  ...
  {id:'c_poisonmist', name:'ポイズンミスト',   race:'亜人', grade:1, atk:3,  hp:9,  cost:2,  unique:false, icon:'🌫️', desc:'', keywords:['毒牙1']},
