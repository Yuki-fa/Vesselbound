...
const UNIT_POOL = [
  ...
  {id:'c_mummy',      name:'マミー',           race:'不死', grade:1, atk:2,  hp:12, cost:3,  unique:false, icon:'🤕', desc:'誘発：このキャラクターが死亡した場合、1ソウルを得る。', effect:'mummy_death'},
  ...
  {id:'c_jackalope',  name:'ジャッカロープ',   race:'獣',   grade:1, atk:4,  hp:8,  cost:4,  unique:false, icon:'🐰', desc:'使役：「治癒の薬」を1枚得る。', effect:'jackalope_summon'},
  ...
  {id:'c_lesser_demon',name:'レッサーデーモン',race:'悪魔', grade:1, atk:5,  hp:10, cost:3,  unique:false, icon:'👿', desc:'誘発：味方が死ぬたび、ソウル1を得る。', effect:'lesser_demon_death', keywords:['成長2']},
