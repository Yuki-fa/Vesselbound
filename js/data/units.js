...
const UNIT_POOL = [
  ...
  {id:'c_banshee',    name:'バンシー',         race:'不死', grade:1, atk:4,  hp:10, cost:3,  unique:false, icon:'👻', desc:'呪詛1',                                       keywords:['呪詛1']},
  {id:'c_pixie',      name:'ピクシー',         race:'精霊', grade:1, atk:2,  hp:8,  cost:3,  unique:false, icon:'🧚', desc:'シールド',                                    shield:1},
  {id:'c_firebreath', name:'ファイアブレス',   race:'竜',   grade:1, atk:8,  hp:7,  cost:4,  unique:false, icon:'🔥', desc:''},
  ...
  {id:'c_satyr',      name:'サテュロス',       race:'亜人', grade:2, atk:9,  hp:20, cost:5,  unique:false, icon:'🐐', desc:''},
  {id:'c_darkelf',    name:'ダークエルフ',     race:'亜人', grade:2, atk:10, hp:18, cost:5,  unique:false, icon:'🧝', desc:'狩人',                                       keywords:['狩人']},
  {id:'c_cursed_armor',name:'カースドアーマー',race:'不死', grade:2, atk:6,  hp:28, cost:5,  unique:false, icon:'🛡️',desc:'呪詛2',                                       keywords:['呪詛2']},
  {id:'c_bone_knight', name:'ボーンナイト',    race:'不死', grade:2, atk:9,  hp:22, cost:5,  unique:false, icon:'⚔️', desc:''},
  {id:'c_dire_wolf',  name:'ダイアウルフ',     race:'獣',   grade:2, atk:13, hp:17, cost:5,  unique:false, icon:'🐺', desc:'二段攻撃',                                   keywords:['二段攻撃']},
  {id:'c_hippogriff', name:'ヒポグリフ',       race:'獣',   grade:2, atk:10, hp:20, cost:5,  unique:false, icon:'🦁', desc:''},
  {id:'c_kelpie',     name:'ケルピー',         race:'獣',   grade:2, atk:8,  hp:24, cost:5,  unique:false, icon:'🐴', desc:''},
  {id:'c_spriggan',   name:'スプリガン',       race:'精霊', grade:2, atk:7,  hp:22, cost:5,  unique:false, icon:'🌿', desc:'シールド',                                   shield:1},
  {id:'c_seaserpent', name:'シーサーペント',   race:'獣',   grade:2, atk:11, hp:20, cost:5,  unique:false, icon:'🐉', desc:''},
  {id:'c_blood_lord', name:'ブラッドロード',   race:'悪魔', grade:2, atk:13, hp:18, cost:6,  unique:false, icon:'🩸', desc:'邪眼5',                                      keywords:['邪眼5']},
