...
const UNIT_POOL = [
  ...
  {id:'c_mummy',      name:'マミー',           race:'不死', grade:1, atk:2,  hp:12, cost:3,  unique:false, icon:'🤕', desc:'ヘイト　負傷：以後、召喚される「魂」が±0/+1を得る。', hate:true, injury:'mummy'},
  ...
  {id:'c_lizardman',  name:'リザードマン',     race:'竜',   grade:1, atk:5,  hp:13, cost:4,  unique:false, icon:'🦎', desc:'逆鱗',                                   injury:'lizardman'},
  ...
  // ─── G2（ドラゴネット変身先） ───
  {id:'c_worm',       name:'ワーム',           race:'竜',   grade:2, atk:9,  hp:22, cost:7,  unique:false, icon:'🪱', desc:'反撃　負傷：すべての味方が+1/+1を得る。', effect:'worm_counter', injury:'worm'},
];
