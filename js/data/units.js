...
const UNIT_POOL = [
  ...
  {id:'c_draug',      name:'ドラウグ',         race:'不死', grade:2, atk:10, hp:22, cost:5,  unique:false, icon:'💀', desc:'誘発：攻撃した敵に「毒3」を与える。', effect:'draug_attack'},
  ...
  {id:'c_centaur',    name:'ケンタウロス',     race:'亜人', grade:2, atk:9,  hp:24, cost:5,  unique:false, icon:'🏇', desc:'二段攻撃　開戦：オーナーの魔術レベルが+1される。',        effect:'centaur_summon', keywords:['二段攻撃']},
...
function makeUnitFromDef(def, fieldIdx, skipSummonBonus){
  ...
  if(def.race==='不死' && typeof G!=='undefined' && G._specterBonus){
