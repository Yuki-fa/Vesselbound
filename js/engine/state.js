...
const KW_DESC_MAP={
  '反撃':     '攻撃を受けた時、攻撃してきた相手に反撃する。',
  '二段攻撃': '1ターンに2回攻撃する。',
  '三段攻撃': '1ターンに3回攻撃する。',
  '全体攻撃': '敵全体を同時に攻撃する。',
  '加護':     '魔法の対象にならない。',
  'シールド': 'ダメージを1回無効化する。',
  '狩人':     '最も攻撃力の高い敵を優先して攻撃する。',
  '即死':     '攻撃が命中した対象を即座に倒す。',
  'ヘイト':   '敵が優先的にこのキャラクターを攻撃する。',
  '隠密':     '敵に狙われない。ただし加護持ちには無効。',
  '成長':     '戦闘開始時、ATK/HPがX増加する（X=キーワードの数値）。',
  '結束':     '戦闘開始時、全ての仲間のATK/HPがX増加する（X=キーワードの数値）。',
  '侵食':     '攻撃時、対象に毒Xを付与する（毒は敵ターン終了時に発動）。',
  '邪眼':     '攻撃時、対象のATKをX減少させる（永続）。',
  '呪詛':     '攻撃時、対象に破滅Xを付与する。破滅が10に達すると即死。',
  '魂喰':     '攻撃時、1ソウルを消費してシールド+1を得る。（味方専用）',
